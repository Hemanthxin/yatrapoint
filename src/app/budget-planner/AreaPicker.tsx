  ...
  return (
    <div className="mb-2">
      <p className="flex items-center gap-2 text-sm font-extrabold text-slate-900">
        {step && (
          <span className="grid h-5 w-5 place-items-center rounded-full bg-gradient-to-br from-emerald-500 to-green-600 text-[11px] font-bold text-white shadow-sm shadow-emerald-500/30">
            {step}
          </span>
        )}
        {title}
