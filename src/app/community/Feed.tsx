      ...
      {composerOpen ? (
        ...
        >
          {userImage ? (
            ...
            <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-sm font-bold text-white shadow-md shadow-emerald-500/30">
              {initial}
            </span>
          )}
          ...
          <span className="relative inline-flex min-h-[44px] shrink-0 items-center gap-1.5 overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 px-4 text-sm font-bold text-white shadow-lg shadow-emerald-500/40 transition hover:scale-[1.02] active:scale-95">
