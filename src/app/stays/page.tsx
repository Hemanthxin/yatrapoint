                ...
                >
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    <a
                      ...
                      className="inline-flex h-11 flex-1 items-center justify-center gap-1.5 rounded-2xl bg-gradient-to-r from-emerald-500 to-green-600 px-3 text-sm font-bold text-white shadow-lg shadow-emerald-500/40 transition hover:scale-[1.03] active:scale-95"
                    >
