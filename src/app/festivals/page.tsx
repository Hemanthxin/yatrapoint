          ...
          return (
            ...
            >
              <div className="relative flex items-center justify-between border-b border-emerald-100/60 bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-4">
                ...
                {isNext && (
                  <span className="absolute -bottom-2 left-4 rounded-full bg-gradient-to-r from-emerald-500 to-teal-600 px-2.5 py-0.5 text-[10px] font-bold text-white shadow-md shadow-emerald-500/40">
