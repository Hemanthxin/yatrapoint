...
export const northwestIndiaDestinations: Omit<NewDestination, "id" | "createdAt">[] = [
  // ───────────────────────── RAJASTHAN ─────────────────────────
  {
    ...
    description: "Amber (Amer) Fort is a magnificent 16th-century fort-palace built by Raja Man Singh, blending Rajput and Mughal architecture. Highlights include the mirrored Sheesh Mahal, Diwan-i-Aam, Ganesh Pol and Sukh Niwas. Visitors can walk or take a jeep up the ramparts and enjoy the evening light-and-sound show. Elephant rides up the fort's approach resumed after a long pause and now cost a hefty ₹2,500 per ride, arranged only on-site — most visitors just walk or jeep up instead.",
    imageUrl: null,
  ...
  },
  {
    ...
    description: "Hawa Mahal, the 'Palace of Winds', was built in 1799 so royal ladies could watch street festivities unseen through its honeycomb of 953 jharokha windows. The pyramidal facade of pink sandstone is Jaipur's most photographed landmark, and a small museum sits within. Frequent visitors to Jaipur's forts can save money with the composite ticket, which bundles Hawa Mahal with Amber Fort, Jantar Mantar, Nahargarh Fort and more over two days.",
  ...
  },
  {
    ...
    description: "The City Palace is a grand complex of courtyards, gardens and buildings blending Rajput and Mughal styles, still partly home to Jaipur's royal family. Highlights include the Mubarak Mahal museum, the peacock-themed Pritam Niwas Chowk gates and the seven-storey Chandra Mahal. The standard ticket covers the museums and courtyards; reaching the upper floors and the famous Blue Room requires the much pricier Royal Splendour ticket.",
  ...
  },
  {
    ...
    description: "Mehrangarh is one of India's largest and best-preserved forts, rising 120 metres above Jodhpur's blue-painted old city. Its palaces — Moti Mahal, Phool Mahal and Sheesh Mahal — house a superb museum of palanquins, arms and paintings, and a zipline circuits the ramparts. Senior citizens and students get a discounted ticket, and entry is free on Jodhpur Foundation Day.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/9/99/Mehrangarh_Fort_sanhita.jpg",
    openingTimings: "9:00 AM - 5:00 PM",
    entryFees: 200,
    entryFeesForeigner: 800,
    budgetPerDay: 2200,
    recommendedDays: 1,
    bestMonths: "Oct,Nov,Dec,Jan,Feb,Mar",
    isHidden: false,
  ...
  },
  {
    ...
    description: "Rising from the Thar Desert like a giant sandcastle, Jaisalmer Fort is one of the few 'living forts' where thousands still reside within its walls. Inside its honey-coloured ramparts are Jain temples, palaces, havelis, shops and guesthouses along winding lanes. The fort itself and the Jain temples share one ticket; visiting the separate Palace Museum inside costs extra.",
  ...
  // ───────────────────────── JAMMU & KASHMIR ─────────────────────────
  {
    ...
    description: "Dal Lake is the shimmering centrepiece of Srinagar, famous for its ornate houseboats, gliding shikara boats, floating vegetable markets and Char Chinar island. Backed by the Zabarwan hills and Mughal gardens, it is the quintessential Kashmir experience. There's no fee to view the lake — the real cost is the shikara ride (officially around ₹700-1,000/hour for up to four people) or an overnight houseboat stay, both negotiated directly with operators.",
  ...
  },
  {
    ...
    description: "Gulmarg, the 'Meadow of Flowers', is a premier Himalayan resort set at around 2,650 metres, blanketed in wildflowers in summer and snow in winter. Its gondola, one of the world's highest, rises toward Apharwat Peak, making it India's top skiing destination. The resort itself is free to wander; the real cost is the two-stage Gulmarg Gondola, which runs to roughly ₹1,800 round-trip for both phases combined, and rises steeply in peak ski season.",
  ...
  },
  {
    ...
    description: "The Vaishno Devi shrine is one of India's most visited Hindu pilgrimage sites, set in a cave high in the Trikuta hills. Devotees trek roughly 12 km uphill from Katra to worship the three natural pindis of the goddess, with helicopter and pony options also available. Darshan and the mandatory Yatra Parchi (registration slip) are free; the helicopter shuttle from Katra runs about ₹2,320 one-way, and a battery car covers the last stretch (Ardhkuwari to Bhawan) for around ₹450.",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/b/b0/Snowfall_in_Vaishno_Devi.jpg",
    openingTimings: null,
    entryFees: 0,
    bookingUrl: "https://maavaishnodevi.org/",
    visitorGuidelines: "Book your free Yatra registration slip online before travelling — it's compulsory and checked en route. Wear comfortable walking shoes for the 12 km climb from Katra; ponies, palanquins, e-carts and the helicopter are paid alternatives for those who can't walk. Warm clothing is needed even outside winter, as the shrine sits at altitude. Photography is not allowed inside the cave sanctum.",
    budgetPerDay: 1900,
    recommendedDays: 2,
    bestMonths: "Mar,Apr,May,Jun,Sep,Oct,Nov",
    isHidden: false,
  ...
  // ───────────────────────── LADAKH ─────────────────────────
  {
    ...
    description: "Pangong Tso is a spectacular high-altitude lake at around 4,350 metres, its waters shifting through vivid shades of blue against barren mountains. Straddling the India-China border, it is a highlight of any Ladakh trip, popular for lakeside camping and photography. There's no fee for the lake itself, but reaching it requires Ladakh's Environment and Development Fee — a one-time ₹400 plus a small daily wildlife-protection charge, paid online before the trip; foreign nationals need a Protected Area Permit arranged through a registered agent instead.",
    imageUrl: null,
    openingTimings: null,
    entryFees: 400,
    bookingUrl: "https://lahdclehpermit.in/",
    visitorGuidelines: "Book the mandatory Ladakh Environment and Development Fee (permit) online before your trip — carry a printed or digital copy, as checkpoints verify it. Acclimatise in Leh for at least a day or two before heading to the lake, since altitude sickness is a real risk this high up. Carry warm layers even in summer — nights are cold — and keep the area litter-free; it's an ecologically sensitive border zone with a visible security presence.",
    budgetPerDay: 2600,
    recommendedDays: 2,
  ...
  // ───────────────────────── PUNJAB ─────────────────────────
  {
    ...
    description: "The Golden Temple, or Harmandir Sahib, is the holiest gurudwara of Sikhism, its gold-plated sanctum seeming to float in the sacred Amrit Sarovar tank. Pilgrims of all faiths are welcomed, join the world's largest free community kitchen (langar) and circle the marble parikrama. Entry, the langar, and free shoe/luggage storage at every gate are all open 24 hours; a head covering is required and scarves are lent free if you don't have one.",
